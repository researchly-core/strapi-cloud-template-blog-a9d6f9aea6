...
export interface ApiAgenticWorkflowTemplateAgenticWorkflowTemplate
  extends Struct.CollectionTypeSchema {
  collectionName: 'agentic_workflow_templates';
  info: {
    displayName: 'Agentic Workflow Template';
    pluralName: 'agentic-workflow-templates';
    singularName: 'agentic-workflow-template';
  };
  options: {
  ...
  attributes: {
    ...
    audience: Schema.Attribute.Component<'shared.audience-section', false> &
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    demo_use_cases: Schema.Attribute.Component<
      'shared.demo-use-case-card',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    transforms: Schema.Attribute.Component<'shared.transforms-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    > &
      Schema.Attribute.Unique;
    use_cases_heading: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiFoerderungenFoerderungen
  extends Struct.CollectionTypeSchema {
  collectionName: 'foerderungens';
  info: {
    displayName: 'F\u00F6rderungen';
    pluralName: 'foerderungens';
    singularName: 'foerderungen';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHomePageHomePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    comparison_item: Schema.Attribute.Component<'shared.before-after', true>;
    content: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    pricing_specifc: Schema.Attribute.Component<'shared.pricing', true>;
    process: Schema.Attribute.Component<'shared.how-it-works', false>;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::agentic-workflow-template.agentic-workflow-template': ApiAgenticWorkflowTemplateAgenticWorkflowTemplate;
      'api::article.article': ApiArticleArticle;
      'api::author.author': ApiAuthorAuthor;
      'api::category.category': ApiCategoryCategory;
      'api::foerderungen.foerderungen': ApiFoerderungenFoerderungen;
